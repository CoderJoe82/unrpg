...
-Got a basic game menu up for start game, load game, quit.
-Added menu functions in menu.py
-Got character creation to pass data to my CharacterClass object now.
...
-Changed character_class.py to character_creation.py to represent all the classes that will be used to create your character in the game.

V-0.0.2
---
-Provided a welcome message that pops up when the player starts the game.
-Provided a 'Character' object to be used when creating any character in the game.

V-0.0.1
---
-First setup. Basic welcome screen started
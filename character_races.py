...
CHARACTER_RACES = {
    "sentient_rock": {
        ...
        "description": "Born of geologic pressure and a stray bolt of wild magic, Sentient Rocks are thoughtful, patient, and incredibly dense. They make for stalwart, if slow, companions.",
        "racial_stat_mods": {
            "Constitution": 2,
            "Strength": 1,
    ...
    "reformed_mimic": {
        ...
        "description": "Having grown tired of a life of ambushing and being kicked by adventurers, this Mimic has chosen a path of self-improvement and polite conversation. Still a bit sticky, though.",
        "racial_stat_mods": {
            "Strength": 1,
            "Constitution": 1,
    ...
    "sapient_scarecrow": {
        ...
        "description": "Animated by harvest spirits and a lingering sense of duty, these beings are surprisingly observant and resilient. They have an irrational fear of fire and a deep love for crows.",
        "racial_stat_mods": {
            "Wisdom": 2,
            "Dexterity": 1,
